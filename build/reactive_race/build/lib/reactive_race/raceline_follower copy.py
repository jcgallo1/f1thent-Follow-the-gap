...
class P:
    ...
    SAFE_GAP_DIST = 6.0       # Umbral de distancia para considerar un rayo como "espacio libre" (en metros)
    BUBBLE_R      = 0.92      # Radio de la burbuja de seguridad alrededor de los obstáculos (en metros) 
